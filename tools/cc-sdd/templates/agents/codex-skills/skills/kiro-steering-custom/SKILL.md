...
description: Reuse the existing Codex instruction for kiro-steering-custom without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
