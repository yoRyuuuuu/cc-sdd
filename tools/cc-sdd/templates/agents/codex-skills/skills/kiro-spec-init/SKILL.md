---
name: kiro-spec-init
description: Reuse the existing Codex instruction for kiro-spec-init without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
