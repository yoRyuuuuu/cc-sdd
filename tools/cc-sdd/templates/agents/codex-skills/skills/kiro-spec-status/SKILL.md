...
description: Reuse the existing Codex instruction for kiro-spec-status without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
