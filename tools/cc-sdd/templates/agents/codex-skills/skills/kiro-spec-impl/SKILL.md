---
name: kiro-spec-impl
description: Reuse the existing Codex instruction for kiro-spec-impl without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
