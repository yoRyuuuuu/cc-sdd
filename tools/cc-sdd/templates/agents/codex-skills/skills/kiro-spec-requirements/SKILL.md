...
description: Reuse the existing Codex instruction for kiro-spec-requirements without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
