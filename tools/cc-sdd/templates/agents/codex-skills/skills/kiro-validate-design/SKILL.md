...
description: Reuse the existing Codex instruction for kiro-validate-design without modifications. Use when Codex Skills should execute this Kiro workflow step.
---
